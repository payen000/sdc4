<footer title="pie de página">
    ...
    <div class="footer-bottom full-width">
        <div class="footer-data footer-end container resonsive centered not-full-width">
            <div class="row">
                <div class="col-0 col-lg-1"></div>
                <div class="col-12 col-lg-10">
                    &copy; 2023 Universidad Iberoamericana Ciudad de México. Prolongación Paseo de la Reforma 880, Lomas de Santa Fe, México, C.P. 01219, Distrito Federal.<br>
                </div>
                <div class="col-0 col-lg-1"></div>
            </div>
        </div>
...
<script src="/sdc3/bootstrap5/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
